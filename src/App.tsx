...
function AttendanceImportModal({uid,subjects,records,defaultTarget,onDone,onClose}:{uid:string,subjects:Subject[],records:Attendance[],defaultTarget:number,onDone:(n:number)=>void,onClose:()=>void}){
  ...
  return <Modal onClose={onClose}>
    ...
    {stage==='analyzing'&&<div className="processing"><span className="spinner"/> Reading {file?.name} and matching it to your subjects…</div>}
    {stage==='importing'&&<div className="processing"><span className="spinner"/> Saving {sum.ready} records…</div>}
    {stage==='review'&&<>
